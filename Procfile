...
#     echo '{ "name": "MetShop", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/MetShop/MetShop
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/MetShop/MetShop production -p $PORT --mongodb-url=$MONGOHQ_URL
